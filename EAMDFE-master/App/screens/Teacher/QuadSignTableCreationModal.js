...
import {createQuadraticSignTableExercise} from "../../api/SignTableExerciseService";
...
export default ({navigation}) => {
    ...
    const [x1ForLabel, setX1ForLabel] = useState("x1");
    const [x2ForLabel, setX2ForLabel] = useState("x2");
    ...
    useEffect(() => {
        if (exercise.x1.length === 0 || exercise.x2.length === 0) {
            setX1ForLabel("x1");
            setX2ForLabel("x2");
        } else if (parseInt(exercise.x1) > parseInt(exercise.x2)) {
            setX1ForLabel(exercise.x2);
            setX2ForLabel(exercise.x1);
        } else {
            setX1ForLabel(exercise.x1);
            setX2ForLabel(exercise.x2);
        }
    }, [exercise.x1, exercise.x2])

    const seePreview = () => {
        navigation.navigate('PreviewScreen', {exerciseType: 'Quadratic function sign table', exercise: exercise})
    }
    ...
    const validateInput = () => {
        ...
        return exercise.a.length > 0 &&
            exercise.b.length > 0 &&
            exercise.c.length > 0 &&
            exercise.x1.length > 0 &&
            exercise.x2.length > 0;
    }
    ...
    const submit = async () => {
        ...
        if (validateInput()) {
            ...
            const response = await createQuadraticSignTableExercise(userAccessToken, exercise);
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <View style={styles.title}>
                    <Text style={styles.titleText}>Quadratic function sign table</Text>
                </View>
            ...
            >
                ...
                <Text style={styles.note}>This form will yield a sign table exercise for a quadratic function of the
                    form ax^2 + bx + c.</Text>
                <ScrollView keyboardDismissMode="on-drag">
                    ...
                    >
                        ...
                        <FormItem
                            ...
                            keyboardType="numeric"
                            value={exercise.c}
                            onChangeText={(input) => setExerciseField('c', input)}
                        />
                        ...
                        <FormItem
                            ...
                            keyboardType="numeric"
                            value={exercise.x1}
                            onChangeText={(input) => setExerciseField('x1', input)}
                        />
                        ...
                        <FormItem
                            ...
                            keyboardType="numeric"
                            value={exercise.x2}
                            onChangeText={(input) => setExerciseField('x2', input)}
                        />
                        ...
                        <Picker
                            ...
                            label={`Sign for interval [${exercise.domainLowerBound},${x1ForLabel}]`}
                            labelStyle={styles.formLabel}
                        ...
                        <Picker
                            ...
                            label={`Sign for interval [${x1ForLabel},${x2ForLabel}]`}
                            labelStyle={styles.formLabel}
                            buttonStyle={styles.formField}
                            iconWrapperStyle={styles.pickerIconStyle}
                        ...
                        <Picker
                            ...
                            label={`Sign for interval [${x2ForLabel},${exercise.domainUpperBound}]`}
                            labelStyle={styles.formLabel}
                            buttonStyle={styles.formField}
                            iconWrapperStyle={styles.pickerIconStyle}
                            selectedValue={exercise.thirdIntervalSign}
                            onSelection={(item) => setExerciseField('thirdIntervalSign', item.value)}
                        />
